...
const PROJECT_SELECT =
  "id, project_name, topology, supabase_url, supabase_publishable_key, supabase_secret_keys, supabase_access_token, supabase_account_id, runtime_db_url, key_status, last_health_check_at, health_error_detail, data_cadastro";
