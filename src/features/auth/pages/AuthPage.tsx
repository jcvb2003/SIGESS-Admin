...
export default function AuthPage() {
  ...
  const submitText = isLogin ? "Entrar" : "Criar conta";
  const loadingText = isLogin ? "Entrando..." : "Criando conta...";
  ...
  useEffect(() => {
    ...
    const { data: { subscription } } = supabase.auth.onAuthStateChange((_event, session) => {
      ...
      if (session && globalThis.location.pathname === "/auth" && !navigationAttempted.current) {
