...
CREATE INDEX IF NOT EXISTS idx_dae_comp ON public.financeiro_dae (competencia_ano, competencia_mes);
CREATE INDEX IF NOT EXISTS idx_dae_grupo ON public.financeiro_dae (grupo_id);
CREATE INDEX IF NOT EXISTS idx_dae_sessao ON public.financeiro_dae (sessao_id);

CREATE INDEX IF NOT EXISTS idx_fin_lanc_socio ON public.financeiro_lancamentos (socio_cpf);
CREATE INDEX IF NOT EXISTS idx_fin_lanc_sessao ON public.financeiro_lancamentos (sessao_id);
CREATE INDEX IF NOT EXISTS idx_fin_lanc_tipo ON public.financeiro_lancamentos (tipo);
CREATE INDEX IF NOT EXISTS idx_fin_lanc_data ON public.financeiro_lancamentos (data_pagamento);
CREATE INDEX IF NOT EXISTS idx_fin_lanc_comp_ano ON public.financeiro_lancamentos (competencia_ano);
CREATE INDEX IF NOT EXISTS idx_fin_lanc_status ON public.financeiro_lancamentos (status);
CREATE INDEX IF NOT EXISTS idx_fin_lanc_tipo_cobranca ON public.financeiro_lancamentos (tipo_cobranca_id);
CREATE INDEX IF NOT EXISTS idx_fin_lanc_socio_tipo_comp ON public.financeiro_lancamentos (socio_cpf, tipo, competencia_ano, competencia_mes);
...
CREATE UNIQUE INDEX IF NOT EXISTS uniq_tipo_cobranca_por_socio ON public.financeiro_lancamentos (socio_cpf, tipo_cobranca_id) WHERE ((status = 'pago'::text) AND (tipo_cobranca_id IS NOT NULL));

CREATE INDEX IF NOT EXISTS idx_cobrancas_socio ON public.financeiro_cobrancas_geradas (socio_cpf);
CREATE INDEX IF NOT EXISTS idx_cobrancas_tipo ON public.financeiro_cobrancas_geradas (tipo_cobranca_id);
CREATE INDEX IF NOT EXISTS idx_cobrancas_status ON public.financeiro_cobrancas_geradas (status);
CREATE UNIQUE INDEX IF NOT EXISTS financeiro_cobrancas_geradas_tipo_id_socio_cpf_key ON public.financeiro_cobrancas_geradas (tipo_cobranca_id, socio_cpf);

CREATE INDEX IF NOT EXISTS idx_regime_socio ON public.financeiro_historico_regime (socio_cpf);
CREATE INDEX IF NOT EXISTS idx_tipos_cobranca_categoria ON public.tipos_cobranca (categoria);
CREATE INDEX IF NOT EXISTS idx_tipos_cobranca_ativo ON public.tipos_cobranca (ativo);

-- 5. TRIGGERS
DROP TRIGGER IF EXISTS trigger_auto_generate_cod_req ON public.requerimentos;
...
DROP TRIGGER IF EXISTS trigger_generate_codigo_localidade ON public.localidades;
...
DROP TRIGGER IF EXISTS trg_tipos_cobranca_upd ON public.tipos_cobranca;
CREATE TRIGGER trg_tipos_cobranca_upd
  BEFORE UPDATE ON public.tipos_cobranca
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS trg_fin_lancamentos_upd ON public.financeiro_lancamentos;
CREATE TRIGGER trg_fin_lancamentos_upd
  BEFORE UPDATE ON public.financeiro_lancamentos
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS trg_fin_dae_upd ON public.financeiro_dae;
CREATE TRIGGER trg_fin_dae_upd
  BEFORE UPDATE ON public.financeiro_dae
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS trg_fin_config_socio_upd ON public.financeiro_config_socio;
CREATE TRIGGER trg_fin_config_socio_upd
  BEFORE UPDATE ON public.financeiro_config_socio
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS trg_cobrancas_geradas_upd ON public.financeiro_cobrancas_geradas;
CREATE TRIGGER trg_cobrancas_geradas_upd
  BEFORE UPDATE ON public.financeiro_cobrancas_geradas
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS trg_fotos_upd ON public.fotos;
CREATE TRIGGER trg_fotos_upd
  BEFORE UPDATE ON public.fotos
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS trg_socios_upd ON public.socios;
...
DROP POLICY IF EXISTS "Allow all for authenticated users" ON public.entidade;
CREATE POLICY "Allow all for authenticated users" ON public.entidade FOR ALL TO authenticated USING (auth.uid() IS NOT NULL);
DROP POLICY IF EXISTS "Allow all for authenticated users" ON public.localidades;
...
DROP POLICY IF EXISTS "Allow all for authenticated users" ON public.requerimentos;
...
DROP POLICY IF EXISTS "Allow all for authenticated users" ON public.parametros_financeiros;
...
DROP POLICY IF EXISTS "Allow all for authenticated users" ON public.tipos_cobranca;
...
DROP POLICY IF EXISTS "Allow all for authenticated users" ON public.financeiro_lancamentos;
...
DROP POLICY IF EXISTS "Allow all for authenticated users" ON public.financeiro_cobrancas_geradas;
...
DROP POLICY IF EXISTS "Allow all for authenticated users" ON public.financeiro_dae;
...
DROP POLICY IF EXISTS "Allow all for authenticated users" ON public.financeiro_config_socio;
...
DROP POLICY IF EXISTS "Allow all for authenticated users" ON public.financeiro_historico_regime;
...
DROP POLICY IF EXISTS "Acesso total para usuários autenticados_documentos" ON storage.objects;
