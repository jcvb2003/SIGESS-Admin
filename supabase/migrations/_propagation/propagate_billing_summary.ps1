$SQL = Join-Path $PSScriptRoot "..\20260613_billing_summary.sql"
...
Run-Migration "ELAINE (ofctchwvvvjpnwznsrpg)"   "postgresql://postgres.ofctchwvvvjpnwznsrpg:Sinpesca123%40@aws-1-us-east-1.pooler.supabase.com:5432/postgres"
Run-Migration "SINPESCA (jmahgvgtjstklabwkkit)" "postgresql://postgres.jmahgvgtjstklabwkkit:Sinpesca123%40@aws-1-us-east-2.pooler.supabase.com:5432/postgres"
